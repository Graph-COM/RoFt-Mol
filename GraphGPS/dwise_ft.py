                ...
                if k in ft_sd:
                    ...
                    if "post_mp" in k:
                        ...
                        if match:
                            ...
                            if layer_number == 15:
                                combined[k] = 0.05 * pt_v + 0.9 * ft_v
                            elif layer_number == 14:
                                combined[k] = 0.05 * pt_v + 0.92 * ft_v
                            elif layer_number == 13:
                                combined[k] = 0.05 * pt_v + 0.92 * ft_v
                            elif 9 < layer_number <= 12:
                                combined[k] = 0.05 * pt_v + 0.95 * ft_v
                            elif 5 < layer_number <= 9:
                                combined[k] = 0 * pt_v + 1 * ft_v
                            else:
                                combined[k] = 0 * pt_v + 1 * ft_v
                        else:
                            combined[k] = 0 * pt_v + 1 * ft_v
