...
def train(args, epoch, model, device, loader, optimizer, weights_regularization, backbone_regularization, 
    ...
    for step, batch in enumerate(epoch_iter):
        ...
        if args.regularization_type == 'feature_map':
            ...
            fea = fea if fea is not None else graph_rep
...
def main():
    ...
    for seed in allseed:
        ...
        source_model.molecule_node_model.load_state_dict(new_dict)
        ...
        return_layers = ['molecule_node_model.gnns.4.mlp.3'] # for GIN
