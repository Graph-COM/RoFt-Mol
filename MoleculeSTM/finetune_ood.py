...
def main():
    ...
    for seed in allseed:
        ...
        tune_params_dict = {
            "all": [model.molecule_node_model.gnns.parameters(), model.graph_pred_linear.parameters()],
            "first_linear": [
                model.molecule_node_model.gnns[0].parameters(),model.graph_pred_linear.parameters()
            ],
            "second_linear": [
                model.molecule_node_model.gnns[1].parameters(),model.graph_pred_linear.parameters()
            ],
            "third_linear": [
                model.molecule_node_model.gnns[2].parameters(),model.graph_pred_linear.parameters()
            ],
            "fourth_linear": [
                model.molecule_node_model.gnns[3].parameters(),model.graph_pred_linear.parameters()
            ],
            "fifth_linear": [
                model.molecule_node_model.gnns[4].parameters(),model.graph_pred_linear.parameters()
            ],
        ...
        args.filename = "Surg-FT" + "_" + args.dataset + "_" + args.tune_option + "_" + args.split + "_" + "Fewshot_" + str(args.fewshot) + "_" + str(args.fewshot_num)
