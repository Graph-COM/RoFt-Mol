...
def main():
    ...
    for seed in allseed:
        ...
        tune_params_dict = {
            "all": [model.gnn.parameters(), output_layer.parameters()],
            # "first_layer": [
            #     model.gnn.layers[0].parameters()
            # ],
            # "second_layer": [
            #     model.gnn.layers[1].parameters()
            # ],
            # "third_layer": [
            #     model.gnn.layers[2].parameters()
            # ],
            # "fourth_layer": [
            #     model.gnn.layers[3].parameters()
            # ],
            # "fifth_layer": [
            #     model.gnn.layers[4].parameters()
            # ],
            "first_linear": [
                model.gnn.layers[0].parameters(),output_layer.parameters()
            ],
            "second_linear": [
                model.gnn.layers[1].parameters(),output_layer.parameters()
            ],
            "third_linear": [
                model.gnn.layers[2].parameters(),output_layer.parameters()
            ],
            "fourth_linear": [
                model.gnn.layers[3].parameters(),output_layer.parameters()
            ],
            # "fifth_linear": [
            #     model.gnn.layers[4].parameters(),output_layer.parameters()
            # ],
            "linear_layer": [output_layer.parameters()],
        }
        #set up optimizer
