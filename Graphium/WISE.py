...
def main():
    ...
    for seed in allseed:
        ...
        ft_state_dict = torch.load('sup_largemix_results/{}/Fewshot_{}_all_{}_Fewshot_{}_{}_seed{}.pth'.format(args.dataset, args.dataset, args.split, args.fewshot, args.fewshot_num, args.runseed))
        ft_cls = torch.load('sup_largemix_results/{}/Fewshot_{}_all_{}_Fewshot_{}_{}_MLP_seed{}.pth'.format(args.dataset, args.dataset, args.split, args.fewshot, args.fewshot_num, args.runseed))
        ...
        # saved_model = model
        # saved_output_layer = output_layer
